...
public class pizzahut_ {
    ...
    public String MenuPrincipal() {
        ...
        System.out.println(" 6.- LIBRO DE RECLAMOS ");
    ...
    public String Comprarenviogratis() {
        ...
        switch (opcion) {
            ...
            case 13:
                ...
                System.out.println("Ud ha pedido " + carrito_enviogratris[13] + "PIZZA de " + enviogratis[2]);
                subtotal_extra[13] = carrito_enviogratris[13] * Precio_promofutbolera[5];
                System.out.println("¿Desea elegir otro menú más?  1 SI/ 2 NO / 3 Menu Principal");
                opcion = maiden.nextInt();
                maiden.nextLine();
                if (opcion == 1) {
    ...
    public String comprarantojitos() {
        ...
        switch (opcion) {
            ...
            case 3:
                ...
                carrito[2] += cantidad;
                System.out.println("Ud ha pedido " + carrito[2] + "pedidos de " + ntojitos[2]);
