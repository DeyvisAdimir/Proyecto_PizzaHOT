...
public class pizzaHut10{
    ...
    public static void main(String[] args) {
        pizzaHut10 pizzaHut = new pizzaHut10();
        pizzaHut.iniciar();
    }
    ...
    private boolean validarCredenciales(String correo, String contraseña) {
        for (int i = 0; i < numeroUsuarios; i++) {
            if (usuarios[i].Correo().equals(correo) && usuarios[i].Contraseña().equals(contraseña)) {
    ...
    private void calcularPago(int[] carrito, double[] precios, String[] items) {
        ...
        System.out.println("Nombre del Cliente: " + usuarioActual.Nombre());
    ...
    private void exportarBoleta(double subtotal, double igv, double totalPagar, String metodoPago, String[] items, int[] carrito, double cambio) {
        try {
            ...
            escritor.write("Nombre del Cliente: " + usuarioActual.Nombre() + "\n");
